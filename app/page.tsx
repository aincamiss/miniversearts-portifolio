...
export default function FunkoPortfolio() {
  const works = [
    ...
    {
      id: 30,
      title: "Ekko - League Of Legends FunkoPOP",
    ...
    {
      id: 31,
      title: "Killjoy - VALORANT FunkoPOP",
    ...
    {
      id: 32,
      title: "Mikasa - Attack On Titan FunkoPOP",
    ...
    {
      id: 34,
      title: "Poppy - League Of Legends FunkoPOP",
    ...
    {
      id: 35,
      title: "Will o mago - Stranger Things FunkoPOP",
    ...
    },
    {
      ...
      images: ["/images/chaveiro empresarial 2.png"],
      image: "/images/chaveiro empresarial 2.png",
      category: "Chaveiros",
    },
    {
      id: 54,
